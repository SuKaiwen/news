                ...
                {this.state.articles.map((article) => {
                    ...
                    return (
                        <article key = {_id} className = "padded">
                            ...
                            <div className = "end">
                                <ul >
                                    <li className = "text_body">{original}</li>
                                    <li className = "text_body">From: {news_desk}</li>
                                    <li className = "text_body">Section: {section_name}</li>
                                    <li className = "text_body">Words: {word_count}</li>
                                </ul>
